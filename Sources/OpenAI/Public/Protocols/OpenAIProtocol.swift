...
public protocol OpenAIProtocol: OpenAIModern {
    ...
    /**
     ...
     - completion: A closure which receives the result when the API request finishes. The closure's parameter, `Result<ImagesResult, Error>`, will contain either the `ImagesResult` object with the generated images, or an error if the request failed.
     **/
    @discardableResult func imageEdits(
    ...
    /**
     ...
     - completion: A closure which receives the result when the API request finishes. The closure's parameter, `Result<ImagesResult, Error>`, will contain either the `ImagesResult` object with the generated images, or an error if the request failed.
     **/
    @discardableResult func imageVariations(
     ...
     **/
    @discardableResult func embeddings(
     ...
     */
    @discardableResult func chatsStream(
        query: ChatQuery,
     ...
     */
    @discardableResult func models(
        completion: @escaping @Sendable (Result<ModelsResult, Error>) -> Void
    ) -> CancellableRequest
     ...
     **/
    @available(iOS 13.0, *)
    @discardableResult func moderations(
     ...
     */
    @discardableResult func audioCreateSpeech(
    ...
    */
     ...
     **/
    @discardableResult func audioTranscriptions(
     ...
     **/
    @discardableResult func audioTranslations(
     ...
     **/
    @discardableResult func assistants(
        after: String?,
     ...
     **/
    @discardableResult func assistantCreate(
    ...
    /**
     ...
     Returns a `Result` of type `AssistantResult` if successful, or an `Error` if an error occurs.
     **/
    @discardableResult func assistantModify(
        query: AssistantsQuery,
        assistantID: String,
        completion: @escaping @Sendable (Result<AssistantResult,Error>) -> Void
    ) -> CancellableRequest
     ...
     **/
    @discardableResult func threads(
        query: ThreadsQuery,
     ...
     **/
    @discardableResult func threadRun(
     ...
     **/
    @discardableResult func runRetrieve(
        threadID: String,
        runID: String,
        completion: @escaping @Sendable (Result<RunResult, Error>) -> Void
    ) -> CancellableRequest
     ...
     **/
    @discardableResult func runRetrieveSteps(
        threadID: String,
        runID: String,
        before: String?,
    ...
    /**
     ...
     Returns a `Result` of type `RunResult` if successful, or an `Error` if an error occurs.
     */
    @discardableResult func runSubmitToolOutputs(
        threadID: String,
        runID: String,
     ...
     **/
    @discardableResult func threadsMessages(
        threadID: String,
        before: String?,
     ...
     **/
    @discardableResult func threadsAddMessage(
        threadID: String,
        query: MessageQuery,
